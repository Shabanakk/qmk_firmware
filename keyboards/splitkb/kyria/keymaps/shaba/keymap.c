...
#define INTL_D LT(_INTL, KC_D)
#define INTL_H LT(_INTL, KC_H)
...
// 222222     666666   765432     234567
//    33333 77777         53210 01235
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT_shaba(
      ...
      KC_LGUI,    KC_Z,    KC_X,    KC_C,  INTL_D,    KC_V,         KC_K,  INTL_H, KC_COMM,  KC_DOT, KC_SLSH, KC_LGUI,
    ...
    [_INTL] = LAYOUT_shaba(
      ...
      _______,  GER_AE, _______,  GER_SS, _______, _______,      _______, _______, US_EURO, _______,  GER_OE, _______,
      _______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______,
               _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______
    ),
    [_L_NUM] = LAYOUT_shaba(
      _______, KC_PERC,    KC_7,    KC_8,    KC_9, KC_HASH,      _______, _______, _______, _______, KC_COLN, _______,
      _______,  KC_EQL,    KC_4,    KC_5,    KC_6, KC_ASTR,      _______, _______, _______, _______, _______, _______,
    ...
    [_R_SYM] = LAYOUT_shaba(
      _______, _______, _______, _______, _______, _______,      KC_PIPE,   KC_AT, KC_LCBR, KC_RCBR, KC_CIRC, _______,
